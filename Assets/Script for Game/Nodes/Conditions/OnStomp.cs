...
[NodeDescription("Returns Success if the entity's feet hits an object with the specified tags, saving the collided entity to the blackboard. Otherwise returns Failure. outputTarget is optional.")]
